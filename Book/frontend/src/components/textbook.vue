    ...
    <el-aside class="el-aside">
      ...
      <el-form
        ...
        <el-form-item label="教学内容" prop="teachingContent">
          <el-input v-model="form.teachingContent" placeholder="请输入教学内容"></el-input>
        </el-form-item>

        <el-form-item label="教学步骤" prop="teachingSteps">
          <el-input v-model="form.teachingSteps" placeholder="请输入教学步骤"></el-input>
        </el-form-item>

        <el-form-item label="教学方法" prop="teachingMethods">
          <el-input v-model="form.teachingMethods" placeholder="请输入教学方法"></el-input>
        </el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: {
        teachingContent: [{ required: true, message: '请输入教学内容', trigger: 'blur' }],
        teachingSteps: [{ required: false, message: '请输入教学步骤', trigger: 'blur' }],
        teachingMethods: [{ required: false, message: '请输入教学方法', trigger: 'blur' }],
