    ...
    <el-aside class="el-aside">
      ...
      <el-form
        ...
        <el-form-item label="目标" prop="goal">
          <el-input v-model="form.goal" placeholder="请输入目标"></el-input>
        </el-form-item>

        <el-form-item label="论点" prop="argument">
          <el-input v-model="form.argument" placeholder="请输入论点"></el-input>
        </el-form-item>

        <el-form-item label="论据" prop="evidence">
          <el-input v-model="form.evidence" placeholder="请输入论据"></el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        argument: [{ required: true, message: '请输入论点', trigger: 'blur' }],
        evidence: [{ required: true, message: '请输入论据', trigger: 'blur' }],
