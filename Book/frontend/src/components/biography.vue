    ...
    <el-aside class="el-aside">
      ...
      <el-form
        ...
        <el-form-item label="人物" prop="character">
          <el-input v-model="form.character" placeholder="请输入人物名称"></el-input>
        </el-form-item>

        <el-form-item label="人物信息" prop="information">
          <el-input v-model="form.information" placeholder="请输入人物信息"></el-input>
        </el-form-item>

        <el-form-item label="人生阶段" prop="lifeStages">
          <el-checkbox-group v-model="form.lifeStages">
            <el-checkbox label="出生背景"></el-checkbox>
            <el-checkbox label="少年时期"></el-checkbox>
            <el-checkbox label="青年时期"></el-checkbox>
            <el-checkbox label="中年时期"></el-checkbox>
            <el-checkbox label="老年时期"></el-checkbox>
          </el-checkbox-group>
        </el-form-item>

        <el-form-item label="侧重点" prop="focusPoints">
          <el-checkbox-group v-model="form.focusPoints">
            <el-checkbox label="生平事迹"></el-checkbox>
            <el-checkbox label="成就"></el-checkbox>
            <el-checkbox label="过失"></el-checkbox>
            <el-checkbox label="影响"></el-checkbox>
            <el-checkbox label="评价"></el-checkbox>
          </el-checkbox-group>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        information: [{ required: true, message: '请输入人物信息', trigger: 'blur' }],
        lifeStages: [{ required: true, type: 'array', min: 1, message: '请选择人生阶段', trigger: 'change' }],
      ...
      chapters: '',
      // bookTitle: 'test_test',
      // chapters: [{'title':'chapter1_test','content':'chapter1_content_test'},
      //   {'title':'chapter2_test','content':'chapter2_content_test'}],
      // currentPage: 1,
    };
  },
  computed: {
