    ...
    <el-aside class="el-aside">
      ...
      <el-form
        ...
        <el-form-item label="故事背景" prop="background">
          <el-input v-model="form.background" placeholder="请输入故事背景"></el-input>
        </el-form-item>

        <el-form-item label="主要人物" prop="characters">
          <el-input v-model="form.characters" placeholder="请输入主要人物"></el-input>
        </el-form-item>

        <el-form-item label="人物关系" prop="relationships">
          <el-input v-model="form.relationships" placeholder="请输入人物关系"></el-input>
        </el-form-item>

        <el-form-item label="主要情节" prop="plot">
          <el-input v-model="form.plot" placeholder="请输入主要情节"></el-input>
        </el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: {
        background: [{ required: false, message: '请输入故事背景', trigger: 'blur' }],
        characters: [{ required: true, message: '请输入主要人物', trigger: 'blur' }],
        relationships: [{ required: false, message: '请输入人物关系', trigger: 'blur' }],
        plot: [{ required: true, message: '请输入主要情节', trigger: 'blur' }],
