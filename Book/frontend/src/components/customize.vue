  ...
  <el-container>
    <el-aside class="el-aside">
      ...
      <el-form
          ...
          label-width="auto">
        <el-form-item label="书籍类型" prop="bookClass">
          <el-input v-model="form.bookClass" placeholder="请输入书籍类型"></el-input>
        </el-form-item>

        <el-form-item label="主要要求" prop="requirement">
          <el-input v-model="form.requirement" placeholder="请输入主要要求"></el-input>
        </el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: {
        bookClass: [{ required: true, message: '请输入书籍类型', trigger: 'blur' }],
        requirement: [{ required: true, message: '请输入主要要求', trigger: 'blur' }],
